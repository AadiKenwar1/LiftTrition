...
/**
 * Presentational view for the onboarding "preboard" screen. Navigation delegated via `onNext`/`onBack`.
 * Shared by the real controller (app/onboardingScreens/preboard.tsx) and the Dev Hub onboarding harness.
 */
export interface PreboardViewProps {
    onNext: () => void
    onBack: () => void
}
...
export default function PreboardView({ onNext, onBack }: PreboardViewProps) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={[styles.buttonContainer, { paddingBottom: Math.max(insets.bottom, 16) + 12 }]}>
                ...
                <TouchableOpacity style={styles.ctaButton} activeOpacity={0.85} onPress={onNext}>
