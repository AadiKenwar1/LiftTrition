...
/**
 * Presentational view for the onboarding intro screen. Pure visual — navigation is delegated via
 * `onNext`. The real controller (app/onboardingScreens/introduction.tsx) wires routing; the Dev Hub
 * onboarding harness renders this same component for drift-free previews + variant comparison.
 */
