...
export default function PaywallView({ loading, hasPremium, purchasing, errorMessage, monthlyAvailable, annualAvailable, monthlyPrice, annualPrice, onSubscribe, onRestore, onFinish, onBack }: PaywallViewProps) {
    const [selectedPlan, setSelectedPlan] = useState<PlanType>('annual')
    const selectedAvailable = selectedPlan === 'monthly' ? monthlyAvailable : annualAvailable
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.pricingRow}>
                    <TouchableOpacity style={[styles.pricingCard, selectedPlan === 'monthly' && { ...styles.pricingCardSelected, borderColor: ACCENT }]} onPress={() => setSelectedPlan('monthly')} activeOpacity={0.8} disabled={!monthlyAvailable}>
                    ...
                    <TouchableOpacity style={[styles.pricingCard, selectedPlan === 'annual' && { ...styles.pricingCardSelected, borderColor: ACCENT }]} onPress={() => setSelectedPlan('annual')} activeOpacity={0.8} disabled={!annualAvailable}>
                        <Text style={styles.planLabel} adjustsFontSizeToFit minimumFontScale={0.65} numberOfLines={1}>
                            Annual
                        </Text>
                        <View style={styles.priceRow}>
                ...
                <View style={styles.subscribeBlock}>
                    <TouchableOpacity
                        ...
                        activeOpacity={0.8}
                        disabled={!selectedAvailable || hasPremium || purchasing}
                    >
                        {purchasing ?
                    ...
                    <TouchableOpacity style={styles.restoreButton} onPress={onRestore} activeOpacity={0.5}>
            ...
            <View style={styles.footer}>
                <View style={styles.navButtonRow}>
                    <TouchableOpacity style={styles.navBackButton} onPress={onBack} activeOpacity={0.8}>
                        <Text style={styles.navBackButtonText}>Back</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.navContinueButton} onPress={onFinish} activeOpacity={0.8}>
