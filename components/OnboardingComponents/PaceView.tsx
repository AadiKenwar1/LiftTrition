...
export interface PaceViewProps {
    value: number
...
export default function PaceView({ value, onChange, onNext, onBack, stepIndex }: PaceViewProps) {
    return (
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.sliderContainer}>
                    ...
                    <View style={styles.valueDisplay}>
                        ...
                        <Text style={styles.valueLabelText}>{getPaceLabel(value)}</Text>
                    </View>

                    {/* Slider with Icons */}
                    <View style={styles.sliderRow}>
                        <Turtle size={24} color="#666" strokeWidth={2} />
                        <Slider style={styles.slider} minimumValue={0.2} maximumValue={3.0} step={0.1} value={value} onValueChange={onChange} minimumTrackTintColor={ACCENT} maximumTrackTintColor="#333" thumbTintColor={ACCENT} />
