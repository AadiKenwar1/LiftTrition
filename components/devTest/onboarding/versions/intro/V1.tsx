...
/**
 * Dev-only Version 1 preview of the Intro onboarding screen — a self-contained copy of the current
 * design (app/onboardingScreens/introduction.tsx). No context/router side effects: the CTA is inert.
 * Duplicate this file to versions/intro/V2.tsx and register it to compare a redesign.
 */
...
export default function IntroV1() {
...
const styles = StyleSheet.create({
    ...
    iconCircle: { width: 144, height: 144, borderRadius: 72, backgroundColor: '#1e1e1e', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#3a3a3a', marginBottom: 8, overflow: 'hidden' },
    logoImage: { width: '85%', height: '85%' },
    appName: { fontSize: 40, color: '#fff', letterSpacing: -1.2, fontFamily: 'Poppins_700Bold', textAlign: 'center', marginBottom: 0 },
    tagline: { fontSize: 15, color: '#aaa', textAlign: 'center', lineHeight: 22, letterSpacing: 0.1, fontFamily: 'Poppins_400Regular', marginBottom: 18 },
    grid: { width: '100%', flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 8 },
    card: { width: '47.5%', backgroundColor: '#1e1e1e', borderRadius: 14, padding: 16, gap: 8, borderWidth: 0, borderColor: '#222' },
    cardIconBox: { width: 40, height: 40, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
    cardTitle: { fontSize: 15, color: '#fff', letterSpacing: -0.3, fontFamily: 'Poppins_600SemiBold' },
    cardBody: { fontSize: 12, color: '#aaa', letterSpacing: 0.1, lineHeight: 17, fontFamily: 'Poppins_400Regular' },
    buttonContainer: { paddingHorizontal: 25, paddingTop: 12 },
    ctaButton: { width: '100%', minHeight: 60, borderRadius: 16, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center', paddingVertical: 16 },
