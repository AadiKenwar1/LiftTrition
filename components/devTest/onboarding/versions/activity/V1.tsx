...
/**
 * Dev-only Version 1 preview of the Activity onboarding screen (app/onboardingScreens/onboarding5.tsx).
...
export default function ActivityV1() {
...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: '#121212', paddingTop: 75, paddingBottom: 50, paddingHorizontal: 25 },
    topGradient: { position: 'absolute', top: 0, left: 0, right: 0, height: 220 },
    scroll: { flex: 1 },
    scrollContent: { alignItems: 'center', width: '100%', paddingTop: 24, paddingBottom: 16 },
    stepIndicator: { flexDirection: 'row', gap: 6, marginBottom: 28 },
    stepDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#333' },
    stepDotActive: { width: 24, backgroundColor: '#2f80ed', borderRadius: 4 },
    ...
    subtitleText: { fontSize: 16, color: '#aaa', textAlign: 'center', letterSpacing: 0.2, lineHeight: 22, marginBottom: 12, paddingHorizontal: 8, fontFamily: 'Poppins_400Regular' },
    optionsContainer: { width: '100%', gap: 8, justifyContent: 'center', marginBottom: 16 },
    optionButton: { width: '100%', minHeight: 65, paddingVertical: 12, backgroundColor: '#1e1e1e', borderRadius: 12, paddingHorizontal: 16, flexDirection: 'column', alignItems: 'stretch', justifyContent: 'center', borderWidth: 2, borderColor: '#1e1e1e', gap: 6 },
    optionLabel: { width: '100%', fontSize: 15, color: '#FFF', letterSpacing: -0.5, fontFamily: 'Poppins_600SemiBold', textAlign: 'left' },
    optionLabelSelected: { color: '#fff' },
    optionSubtitle: { width: '100%', fontSize: 14, color: '#aaa', letterSpacing: 0.1, lineHeight: 20, fontFamily: 'Poppins_400Regular' },
    optionSubtitleSelected: { color: '#aaa' },
    ...
    nextButton: { flex: 1, height: 60, backgroundColor: '#D4E4FF', borderRadius: 16, justifyContent: 'center', alignItems: 'center', shadowColor: ACCENT, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.2, shadowRadius: 12, elevation: 8 },
