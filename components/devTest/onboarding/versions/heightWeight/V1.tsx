...
/**
 * Dev-only Version 1 preview of the Height & Weight onboarding screen (app/onboardingScreens/onboarding4.tsx).
 * Self-contained: local inputs + the real unit-toggle conversions, Back returns to the versions list, Next is inert.
 */
const AMBER = '#FBBF24'

export default function HeightWeightV1() {
...
const styles = StyleSheet.create({
    ...
    iconCircle: { width: 144, height: 144, borderRadius: 72, backgroundColor: '#1e1e1e', justifyContent: 'center', alignItems: 'center', borderWidth: 1.5, marginBottom: 12 },
    titleText: { fontSize: 22, color: '#fff', letterSpacing: -0.5, marginBottom: 4, textAlign: 'center', fontFamily: 'Poppins_600SemiBold' },
    subtitleText: { fontSize: 16, color: '#aaa', textAlign: 'center', lineHeight: 22, letterSpacing: 0.2, marginBottom: 24, paddingHorizontal: 8, fontFamily: 'Poppins_400Regular' },
    toggleContainer: { flexDirection: 'row', width: '100%', gap: 12, marginBottom: 24 },
    toggleButton: { flex: 1, height: 60, justifyContent: 'center', alignItems: 'center', backgroundColor: '#1e1e1e', borderRadius: 14, borderWidth: 2, borderColor: '#242424' },
    toggleText: { fontSize: 16, color: '#888', letterSpacing: -0.5, fontFamily: 'Poppins_600SemiBold' },
    toggleTextActive: { color: '#fff' },
    inputContainer: { width: '100%', gap: 16, marginBottom: 32 },
    inputGroup: { width: '100%' },
    inputLabel: { fontSize: 16, color: '#aaa', marginBottom: 8, paddingLeft: 4, letterSpacing: -0.5, fontFamily: 'Poppins_600SemiBold' },
    inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1e1e1e', borderRadius: 14, borderWidth: 1, borderColor: '#242424', paddingHorizontal: 16, height: 60 },
    input: { flex: 1, fontSize: 16, color: '#fff', letterSpacing: -0.5, fontFamily: 'Poppins_600SemiBold' },
    unitText: { fontSize: 14, color: '#666', marginLeft: 12, letterSpacing: -0.5, fontFamily: 'Poppins_600SemiBold' },
    ...
    nextButton: { flex: 1, height: 60, backgroundColor: '#FFF1CC', borderRadius: 16, justifyContent: 'center', alignItems: 'center', shadowColor: AMBER, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.2, shadowRadius: 12, elevation: 8 },
