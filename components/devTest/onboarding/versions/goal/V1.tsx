...
/**
 * Dev-only Version 1 preview of the Goal onboarding screen (app/onboardingScreens/onboarding6.tsx).
 * Self-contained: local goal/target state (unit hardcoded for the preview), Back returns to the list, Next is inert.
 */
const ACCENT = '#22C922'
const UNIT_SYSTEM: 'imperial' | 'metric' = 'metric'

export default function GoalV1() {
                    ...
                    {goal && goal !== 'maintain' && (
                        <View style={styles.inputGroup}>
                            ...
                            <View style={styles.inputWrapper}>
                                <TextInput style={styles.input} placeholder={UNIT_SYSTEM === 'imperial' ? '150' : '68'} placeholderTextColor="#555" keyboardType="numeric" value={targetWeight} onChangeText={setTargetWeight} />
...
const styles = StyleSheet.create({
    ...
    scroll: { flex: 1 },
    scrollContent: { paddingHorizontal: 25, alignItems: 'center', paddingTop: 50, paddingBottom: 24 },
    ...
    goalButton: { flex: 1, height: 60, justifyContent: 'center', alignItems: 'center', backgroundColor: '#242424', borderRadius: 14, borderWidth: 2, borderColor: '#242424' },
    goalText: { fontSize: 16, color: '#aaa', letterSpacing: -0.5, fontFamily: 'Poppins_500Medium' },
    ...
    inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#242424', borderRadius: 14, borderWidth: 1, borderColor: '#242424', paddingHorizontal: 16, height: 60, marginBottom: 8 },
    input: { flex: 1, fontSize: 16, color: '#fff', letterSpacing: -0.5, fontFamily: 'Poppins_600SemiBold' },
    unitText: { fontSize: 16, color: '#aaa', marginLeft: 12, letterSpacing: -0.5, fontFamily: 'Poppins_600SemiBold' },
    maintainMessageContainer: { width: '100%', paddingVertical: 20, paddingHorizontal: 20, borderRadius: 14, borderWidth: 1, marginBottom: 24, backgroundColor: '#1e1e1e', borderColor: '#1e1e1e' },
    maintainMessageText: { fontSize: 16, color: '#aaa', textAlign: 'center', letterSpacing: 0.2, fontFamily: 'Poppins_400Regular' },
