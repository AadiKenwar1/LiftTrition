...
/**
 * Dev-only Version 1 preview of the Birthday onboarding screen (app/onboardingScreens/onboarding2.tsx).
 * Self-contained: local date state, Back returns to the versions list, Next is inert.
 */
export default function BirthdayV1() {
...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: '#121212', padding: 25, paddingTop: 35, paddingBottom: 50 },
    ...
    iconCircle: { width: 144, height: 144, borderRadius: 72, backgroundColor: '#1e1e1e', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#2f80ed', marginBottom: 12 },
    titleText: { fontSize: 25, color: '#fff', letterSpacing: -0.5, marginBottom: 4, textAlign: 'center', fontFamily: 'Poppins_600SemiBold' },
    subtitleText: { fontSize: 16, color: '#aaa', textAlign: 'center', lineHeight: 22, letterSpacing: 0.2, marginBottom: 12, paddingHorizontal: 16, fontFamily: 'Poppins_400Regular' },
    datePickerContainer: { width: '100%', paddingHorizontal: 4, marginBottom: 32 },
    ...
    nextButton: { flex: 1, height: 60, backgroundColor: '#D4E4FF', borderRadius: 16, justifyContent: 'center', alignItems: 'center', shadowColor: '#2f80ed', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.2, shadowRadius: 12, elevation: 8 },
