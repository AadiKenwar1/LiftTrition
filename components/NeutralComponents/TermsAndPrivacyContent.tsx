...
export default function TermsAndPrivacyContent() {
    return (
        <ScrollView style={contentStyles.container} contentContainerStyle={contentStyles.content} showsVerticalScrollIndicator={false}>
            ...
            <Section title="1. Acceptance of Terms">By downloading, accessing, or using LiftTrition ("the App"), you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree, please do not use the App.</Section>
            ...
            <Section title="3. Description of Service">LiftTrition is a fitness and nutrition tracking app that helps you:</Section>
            <BulletList
            ...
            <Section title="10. Disclaimer">
                LiftTrition provides fitness and nutrition information for general guidance only. It is not a substitute for professional medical, nutritional, or fitness advice. Always consult a healthcare provider before making significant changes
