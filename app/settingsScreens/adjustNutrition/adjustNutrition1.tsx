...
export default function AdjustNutrition1Screen() {
    ...
    // Never seeded from settings.goalWeight. A stored target is stale the moment the weight above it moves,
    // and on maintain it IS the body weight, so seeding hands the user a number validateTargetWeight rejects.
    // Someone on this screen is here to choose a goal, so the field asks for one and the placeholder suggests
    // a distance rather than replaying what was saved.
