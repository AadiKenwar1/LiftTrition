...
function makeStyles(colors: Colors) {
    return StyleSheet.create({
        ...
        laterButton: { flex: 1, minHeight: 58, paddingVertical: 12, borderRadius: radius.cardLg, backgroundColor: colors.surface, justifyContent: 'center', alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.hairline },
